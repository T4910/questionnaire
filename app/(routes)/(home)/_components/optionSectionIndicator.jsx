...
const optionSectionIndicator = ({ originalOpts, displayedOpts, isMobile }) => {
    // console.log( originalOpts, displayedOpts, 999)
    return (
      <div className={`${(originalOpts.length/4 <= 1) ? 'invisible' : ''} ${isMobile ? 'hidden' : ''} grid place-items-center mt-4`}>
